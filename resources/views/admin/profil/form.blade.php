<form action="{{ route('perbarui-profil') }}" method="post"
    ...
    <label class="input input-bordered input-primary flex items-center gap-2">
        ...
        <input type="text" name="nama_pengguna" value="{{ $akun->nama_pengguna }}" class="grow" placeholder="Nama Pengguna" />
    </label>
    <label class="input input-bordered input-primary flex items-center gap-2">
    ...
    <label class="input input-bordered input-primary flex items-center gap-2">
        ...
        <input type="email" name="email" value="{{ $akun->email }}" class="grow" placeholder="Email" />
    </label>
